    ...
    <main className="min-h-screen bg-slate-950 text-slate-50 flex flex-col items-center justify-center p-6 selection:bg-blue-500/30">
      ...
      <div className="relative z-10 w-full max-w-2xl text-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-12">
          {/* <a 
            href="https://scorix.tradalab.com" 
            target="_blank"
            className="group p-6 text-left bg-slate-900/40 border border-slate-800 rounded-3xl hover:border-blue-500/50 hover:bg-slate-900/60 transition-all duration-300"
          >
            <h3 className="text-lg font-semibold group-hover:text-blue-400 transition-colors">Documentation &rarr;</h3>
            <p className="mt-2 text-sm text-slate-500 leading-relaxed">
              Explore the Scorix SDK, IPC patterns, and architecture guides.
            </p>
          </a> */}
